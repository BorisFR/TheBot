...
{
public:
    /*void setDisplay(TheScreen *screen)
    {
        theScreen = screen;
    }*/
    ...
    static void FillEllipseCorner(CornerType corner, int16_t x0, int16_t y0, int32_t rx, int32_t ry, uint16_t color)
    {
        ...
        if (corner == T_R)
        {
            ...
            {
                theScreen.drawHLine(x0, y0 - y, x, color);
                if (s >= 0)
                {
                    s += fx2 * (1 - y);
                    y--;
        ...
        else if (corner == B_R)
        {
            for (x = 0, y = ry, s = 2 * ry2 + rx2 * (1 - 2 * ry); ry2 * x <= rx2 * y; x++)
            {
                theScreen.drawHLine(x0, y0 + y - 1, x, color);
                if (s >= 0)
                {
                    s += fx2 * (1 - y);
                    y--;
        ...
        else if (corner == T_L)
        {
            for (x = 0, y = ry, s = 2 * ry2 + rx2 * (1 - 2 * ry); ry2 * x <= rx2 * y; x++)
            {
                theScreen.drawHLine(x0 - x, y0 - y, x, color);
                if (s >= 0)
                {
                    s += fx2 * (1 - y);
                    y--;
        ...
        else if (corner == B_L)
        {
            for (x = 0, y = ry, s = 2 * ry2 + rx2 * (1 - 2 * ry); ry2 * x <= rx2 * y; x++)
            {
                theScreen.drawHLine(x0 - x, y0 + y - 1, x, color);
                if (s >= 0)
                {
                    s += fx2 * (1 - y);
                    y--;
